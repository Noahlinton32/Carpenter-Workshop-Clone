...
const EditReferral = () => {
  ...
  useEffect(() => {
    const getReferral = async () => {
      try {
        const res = await axios.get(`https://carpenterservice.onrender.com/referrals/${id}`);
  ...
  const handleSubmit = async (event) => {
    ...
    if (hasErrors) {
      ...
      await axios.put(`https://carpenterservice.onrender.com/referrals/${id}`, formWithoutCircularReferences);
      navigate('/referrals');
    }
  };
  return (
